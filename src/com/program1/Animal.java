...
class dog extends Animal{ // we can declare this in public [eg:public class dog extends Animal]
		public void braking() { // this is also we declare in public[eg:public void braking()]
			System.out.println("braking");
		}
	}
		class cat extends Animal{ // create a class with modifiers [eg:public class cat extends Animal]
			public void mewo() { // this method also create with modifiers [eg: public void meow]
				System.out.println("Mewo");
			}
		}
			class Lion extends Animal{ // [eg:public class Lion extends Animal]
				public void roar() { // create a method with modifier [eg:public void roar]
					System.out.println("Roar");
				}
			}
			public class Animal{
				public void eat(){ //[eg:public void eat]
